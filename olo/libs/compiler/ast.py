...
from olo.compat import get_items

from olo.libs.compiler.consts import CO_VARARGS, CO_VARKEYWORDS
...
class AssAttr(Node):
    ...
    def __repr__(self):
        return 'AssAttr(%s, %s, %s)' % (repr(self.expr), repr(self.attrname),
                                        repr(self.flags))
...
class AugAssign(Node):
    ...
    def __repr__(self):
        return 'AugAssign(%s, %s, %s)' % (
            repr(self.node), repr(self.op), repr(self.expr))
...
class CallFunc(Node):
    def __init__(
            self, node, args,
            star_args=None, dstar_args=None, lineno=None):
        self.node = node
        self.args = args
    ...
    def __repr__(self):
        return 'CallFunc(%s, %s, %s, %s)' % (
            repr(self.node), repr(self.args),
            repr(self.star_args), repr(self.dstar_args))


class Class(Node):
    def __init__(self, name, bases, doc, code,
                 decorators=None, lineno=None):
        self.name = name
        self.bases = bases
        self.doc = doc
        self.code = code
    ...
    def __repr__(self):
        return 'Class(%s, %s, %s, %s, %s)' % (
            repr(self.name), repr(self.bases), repr(self.doc),
            repr(self.code), repr(self.decorators))
...
class Exec(Node):
    ...
    def __repr__(self):
        return 'Exec(%s, %s, %s)' % (repr(self.expr), repr(self.locals),
                                     repr(self.globals))
...
class For(Node):
    ...
    def __repr__(self):
        return 'For(%s, %s, %s, %s)' % (
            repr(self.assign), repr(self.list), repr(self.body),
            repr(self.else_))
...
class From(Node):
    ...
    def __repr__(self):
        return 'From(%s, %s, %s)' % (
            repr(self.modname), repr(self.names), repr(self.level))


class Function(Node):
    def __init__(self, decorators, name, argnames, defaults,
                 flags, doc, code, lineno=None):
        self.decorators = decorators
        self.name = name
    ...
    def __repr__(self):
        return 'Function(%s, %s, %s, %s, %s, %s, %s)' % (
            repr(self.decorators), repr(self.name),
            repr(self.argnames), repr(self.defaults),
            repr(self.flags), repr(self.doc), repr(self.code))
...
class GenExprFor(Node):
    ...
    def __repr__(self):
        return 'GenExprFor(%s, %s, %s)' % (
            repr(self.assign), repr(self.iter), repr(self.ifs))
...
class IfExp(Node):
    ...
    def __repr__(self):
        return 'IfExp(%s, %s, %s)' % (repr(self.test), repr(self.then),
                                      repr(self.else_))
...
class Lambda(Node):
    ...
    def __repr__(self):
        return 'Lambda(%s, %s, %s, %s)' % (
            repr(self.argnames), repr(self.defaults),
            repr(self.flags), repr(self.code))
...
class ListCompFor(Node):
    ...
    def __repr__(self):
        return 'ListCompFor(%s, %s, %s)' % (repr(self.assign),
                                            repr(self.list), repr(self.ifs))
...
class Raise(Node):
    ...
    def __repr__(self):
        return 'Raise(%s, %s, %s)' % (repr(self.expr1), repr(self.expr2),
                                      repr(self.expr3))
...
class Slice(Node):
    ...
    def __repr__(self):
        return 'Slice(%s, %s, %s, %s)' % (repr(self.expr), repr(self.flags),
                                          repr(self.lower), repr(self.upper))
...
class Subscript(Node):
    ...
    def __repr__(self):
        return 'Subscript(%s, %s, %s)' % (repr(self.expr), repr(self.flags),
                                          repr(self.subs))
...
class TryExcept(Node):
    ...
    def __repr__(self):
        return 'TryExcept(%s, %s, %s)' % (repr(self.body), repr(self.handlers),
                                          repr(self.else_))
...
class With(Node):
    ...
    def __repr__(self):
        return 'With(%s, %s, %s)' % (
            repr(self.expr), repr(self.vars), repr(self.body))
...
for name, obj in get_items(globals()):
